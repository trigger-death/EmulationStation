...
enum
{
	TABLE_METADATA_FILEID_COL,
	TABLE_METADATA_SYSTEMID_COL,
	TABLE_METADATA_TAG_COL,
	TABLE_METADATA_VALUE_COL
};
...
enum
{
	QUERY_GAMES_FILEID_COL,
	QUERY_GAMES_SYSTEMID_COL,
	QUERY_GAMES_PATH_COL,
	QUERY_GAMES_RATING_COL,
	QUERY_GAMES_PLAYCOUNT_COL,
	QUERY_GAMES_NAME_COL
};
